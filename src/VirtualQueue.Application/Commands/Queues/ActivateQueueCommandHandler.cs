...
public class ActivateQueueCommandHandler : IRequestHandler<ActivateQueueCommand, QueueDto>
{
    private readonly IQueueRepository _queueRepository;
    private readonly IMapper _mapper;

    public ActivateQueueCommandHandler(IQueueRepository queueRepository, IMapper mapper)
    {
        _queueRepository = queueRepository;
        _mapper = mapper;
    }

    public async Task<QueueDto> Handle(ActivateQueueCommand request, CancellationToken cancellationToken)
    {
